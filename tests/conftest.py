...
@pytest.fixture
def page():
    return {'greeting': 'Добрый день', 'cards': [{'last_digits': '*4556', 'total_spent': 9115.3, 'cashback': 91.15}, {'last_digits': '*5441', 'total_spent': 196143.78, 'cashback': 1961.44}, {'last_digits': '*7197', 'total_spent': 17671.41, 'cashback': 176.71}], 'top_transactions': [{'date': '15.02.2018', 'amount': 30000.0, 'category': 'Пополнения', 'description': 'Перевод с карты'}, {'date': '15.02.2018', 'amount': 30000.0, 'category': 'Пополнения', 'description': 'Перевод с карты'}, {'date': '09.02.2018', 'amount': 30000.0, 'category': 'Пополнения', 'description': 'Перевод с карты'}, {'date': '09.02.2018', 'amount': 30000.0, 'category': 'Пополнения', 'description': 'Перевод с карты'}, {'date': '15.02.2018', 'amount': 29963.87, 'category': 'Пополнения', 'description': 'Перевод с карты'}], 'currency_rates': [{'currency': 'USD', 'rate': 85.67821}, {'currency': 'EUR', 'rate': 93.650737}], 'stock_prices': [{'stock': 'AAPL', 'price': 189.68214}, {'stock': 'AMZN', 'price': 168.6823}, {'stock': 'GOOGL', 'price': 153.1682}, {'stock': 'MSFT', 'price': 404.13535}, {'stock': 'TSLA', 'price': 203.6644}]}